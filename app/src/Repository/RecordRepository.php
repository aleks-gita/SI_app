...
class RecordRepository
{
    ...
    private $data = [
        ...
        2 => [
            'id' => 2,
            'question' => 'Etiam diam ipsum, dignissim eget suscipit nec, faucibus accumsan felis',
            'answer' => 'Nullam malesuada ipsum non ligula feugiat consequat. Aliquam quis magna condimentum, pharetra dui eget, gravida ipsum. Donec porta fringilla sagittis. Donec vel ante sit amet mauris faucibus vehicula ac quis enim. Nunc maximus, neque sed tristique elementum, velit ex ornare augue, quis malesuada ante ligula vitae arcu. Sed convallis, est et pulvinar placerat, leo dui dictum tortor, vitae vehicula mauris turpis sit amet eros. Proin ultrices, nunc a aliquam accumsan, nisi ligula vulputate libero, a dapibus nulla felis in diam. Sed egestas metus condimentum egestas facilisis.',
            'tags' => [
                'Phasellus',
                'vestibulum',
                'tortor',
