 ...
 */
final class Version20210616173452 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE answers (id INT AUTO_INCREMENT NOT NULL, questions_id INT DEFAULT NULL, date DATE NOT NULL, content VARCHAR(255) NOT NULL, indication TINYINT(1) NOT NULL, title VARCHAR(255) NOT NULL, INDEX IDX_50D0C606BCB134CE (questions_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
